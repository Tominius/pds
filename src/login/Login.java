...
public class Login {
    ...
    public AbstractUserLog crearInstancia() {
        ...
        if (tipoUsuario.equals("administrador")) {
            ...
            return new ClienteLog(username, password, datos.obtenerDatosParaClienteLog(username).get(3), datos.obtenerDatosParaClienteLog(username).get(4), datos.obtenerDatosParaClienteLog(username).get(5));
        } else if (tipoUsuario.equals("vendedor")) {
            // Crear instancia de la clase VendedorLog
            return new VendedorLog(username, password, datos.obtenerDatosParaVendedorLog(username).get(3));
        } else {
